...
exports.handler = async (event) => {
    let filesProcessed = event.Records.map(async (record) => {
        ...
        // See Imagemagick documentation for arguments and methods.
        let resizeArgs = {
...
//Deploy using s3 bucket and CLI
// 1. aws s3 cp compressedLambas/resizeImages.zip s3://william-images/resizeImages.zip
// 2. aws lambda update-function-code --function-name resizeImages --s3-bucket william-images --s3-key resizeImages.zip --publish